        ...
        <div class="container">
            <div class="row align-items-center g-4 justify-content-between">
                ...
                <div class="col-lg-5 mb-4 col-12 d-flex flex-column justify-content-start">
                    ...
                    <p>
                        you dont have an account ?<a href="register.html" class="unique-text">
                            register now</a>
                    </p>
                    ...
                    <p>
                        forgot password ?
                        <a href="#" class="unique-text">reset password</a>
                    </p>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center g-4">
                ...
                <div
                    ...
                    <ul class="d-flex flex-column gap-3">
                        <li class="d-flex align-items-center gap-2">
                            <i class="bi bi-chevron-right"></i><a href="#">facebook</a>
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <i class="bi bi-chevron-right"></i><a href="#">instagram</a>
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <i class="bi bi-chevron-right"></i><a href="#">linkedin</a>
                        </li>
                        <li class="d-flex align-items-center gap-2">
                            <i class="bi bi-chevron-right"></i><a href="#">x</a>
                        </li>
                    </ul>
                </div>
                <div
                    ...
                    <ul class="d-flex flex-column gap-3">
                        ...
                        <li class="d-flex align-items-center gap-2">
                            <i class="bi bi-chevron-right"></i><a href="#">web developement</a>
                        </li>
                        <li class="d-flex align-items-center gap-2">
            ...
            <div class="container">
                <div class="row">
                    <div
                        ...
                        <p class="creadits">
                            &copy; 2024 Created by: <a href="#">erramix</a>
                        </p>
                    </div>
                    <div
