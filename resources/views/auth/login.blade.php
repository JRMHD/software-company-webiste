        ...
        <div class="container">
            <div class="row align-items-center g-4 justify-content-between">
                <div class="col-lg-6 col-12">
                    <img src="images/auth/login.svg" alt="login" />
                </div>
        ...
        <div class="container">
            <div class="row justify-content-center align-items-center g-4">
                ...
                <div
                    ...
                    <ul class="d-flex flex-column gap-3">
                        ...
                        <li class="d-flex align-items-center gap-2">
                            <i class="bi bi-chevron-right"></i><a href="#">twitter</a>
                        </li>
                        <li class="d-flex align-items-center gap-2">
            ...
            <div class="d-flex flex-wrap justify-content-between align-items-center">
                <p class="text-center text-sm mb-0">
                    © 2024 Techida. All rights reserved. Designed by
                    <a class="text-primary" href="https://www.techida.com" target="_blank">Techida</a>
                </p>
