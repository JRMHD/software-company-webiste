...
<body>
    ...
    <section class="breadcrumbs py-4" data-aos="fade-up" data-aos-delay="100">
        <div class="container">
            ...
            <h2 class="title">single blog page</h2>
                ...
                <div class="col-lg-8 entries" data-aos="fade-right" data-aos-delay="150">
                    <article class="entry entry-single">
                        ...
                        <div class="entry-meta">
                            <ul>
                                ...
                                <li class="d-flex align-items-center"><i class="bi bi-clock"></i> <a
                                        href="blog-single.html"><time datetime="2024-01-01">Jan 1, 2024</time></a>
                                </li>
                        ...
                        <div class="entry-content">
                            ...
                            <p>
                                ...
                                assumenda quia quae a
                                id praesentium. Quos deleniti libero sed occaecati aut porro autem. Consectetur sed
                                excepturi sint non
                    ...
                    <div class="blog-author d-flex align-items-center">
                        ...
                        <div>
                            ...
                            <p>
                                Itaque eum sed possimus accusantium. Quas repellat voluptatem officia numquam sint
                                aspernatur voluptas.
                    ...
                    <div class="blog-comments">
                        ...
                        <div id="comment-2" class="comment">
                            ...
                            <div id="comment-reply-1" class="comment comment-reply">
                                <div class="d-flex">
                                    <div class="comment-img"><img src="images/testimonials/testimonials-3.jpg"
                                            alt="comment-img"></div>
                                    <div>
                                        <h5><a href="#">john smith</a> <a href="#" class="reply"><i
                                                    class="bi bi-reply-fill"></i> Reply</a>
                                        </h5>
                                        <time datetime="2024-01-01">01 Jan, 2024</time>
                                        <p>
                                            ...
                                            porro aut. Magnam qui cum.
                                            Illo similique occaecati nihil modi eligendi. Pariatur distinctio labore
                                            omnis incidunt et illum.
                                ...
                                <div id="comment-reply-2" class="comment comment-reply">
                                    <div class="d-flex">
                                        <div class="comment-img"><img src="images/testimonials/testimonials-2.jpg"
                                                alt="comment-img"></div>
                                        <div>
                                            ...
                                            <p>
                                                ...
                                                unde qui eligendi sapiente omnis ullam. Placeat porro est commodi est
                                                officiis voluptas repellat
                        ...
                        <div id="comment-3" class="comment">
                            <div class="d-flex">
                                <div class="comment-img"><img src="images/testimonials/testimonials-1.jpg"
                                        alt="comment-img"></div>
                                <div>
                            ...
                            <form action="#">
                                <div class="row g-3">
                                    <div class="col-md-6 form-group">
                                        <input name="name" type="text" class="form-control box"
                                            placeholder="Your Name*">
                                    </div>
                                    <div class="col-md-6 form-group">
                                        <input name="email" type="text" class="form-control box"
                                            placeholder="Your Email*">
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col form-group">
                                        <input name="website" type="text" class="form-control box"
                ...
                <div class="col-12 my-4" data-aos="fade-up" data-aos-delay="250">
                    <div class="box">
                        ...
                        <p id="answer1" class="collapse">
                            Lorem ipsum, dolor sit amet consectetur adipisicing elit. Ipsum ullam earum itaque, quas
                            labore illo
                            eligendi iure asperiores, modi veniam molestiae vero quasi. Ex, alias modi voluptates
                            aspernatur
                            consequuntur facere?
                        </p>
                    </div>
